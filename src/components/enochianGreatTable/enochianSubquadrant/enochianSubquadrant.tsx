...
import "./enochianSubquadrant.css"
...
const EnochianSubquadrant = (props: {watchtowerReferenceNumber: number, startRow: number, startColumn: number}) => {
...
export default EnochianSubquadrant